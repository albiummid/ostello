  ...
  return (
    <div className='overflow-x-hidden mb-10 '>
      <div className=' wrapper w-screen select-none bg-[#7A81DC] '>
        <div className='header_container text-white  py-5  pb-[200px] md:pb-[180px] bg-[#7A81DC] '>
            ...
            <div className='flex items-center '>
              <div className='lg:w-[50%] mx-auto '>
                <div className='flex justify-between flex-wrap'>
                  ...
                  <div className=''>
                    <section className='intro flex  flex-col px-5'>
                      ...
                      <div className='flex gap-2  mt-5 mb-5'>
                        <img className='w-8 h-10' src={icons.location} alt='' />
                        <p className='md:text-lg text-md  md:w-[36ch]'>
                    ...
                    <section className='Heading flex justify-center mt-10'>
                      <div className='mb-10 '>
                        <p className='md:text-[56px] font-bold text-center md:text-left  leading-tight md:w-[20ch] mx-auto mb-2 text-4xl'>
                          The Complete Digital Marketing Course
                        </p>
                        <p className='md:text-xl text-center md:text-left text-lg  md:w-[60ch]  md:text-start'>
      ...
      <div className='max-w-7xl mx-auto'>
        <section className=' lg:w-[1347px] Card flex justify-evenly text-[#414141] p-10 rounded-3xl md:flex-row flex-col  bg-white  flex-wrap gap-5  shadow-xl md:mx-auto md:-mt-[100px] -mt-[150px] z-[999] my-10 mx-5 px-5'>
