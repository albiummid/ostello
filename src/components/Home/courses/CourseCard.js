      ...
      <div className='p-6 flex flex-col gap-3'>
        <div className=' flex items-center justify-between '>
          ...
          <div className='p-2 w-[50px] h-[50px]   rounded-full bg-white shadow-lg text-[#767676] justify-center items-center flex cursor-pointer '>
            {/* <img className=' w-[25px] h-[25px] ' src={icons.share} alt='' /> */}
        ...
        <div className='flex items-end justify-between '>
          ...
          <div className='flex items-center justify-center  gap-1 px-2  text-2xl text-white  font-bold bg-yellow-400 rounded-lg '>
            <p>3.0</p>
            <StarFilled />
          </div>
        </div>
        <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-2 items-center text-lg font-bold cursor-pointer active:opacity-75 select-none'>
            <p>View Details</p>
